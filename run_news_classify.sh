...
python news_classify.py -tr 'train_PEST.tsv' -d /home/osung/data/korean/kmaps_corpus -m monologg/koelectra-base-v3-discriminator -b 64 -v PEST -l 256 -t 16 -c /home/osung/Downloads/kisti_cert.crt -e 10 -n 4 --save_every_iter
