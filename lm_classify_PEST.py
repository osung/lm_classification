...
# convert topic from PEST to 0123
if target != 'code' :
    codes = {'P': 0,
             'E': 1,
             'S': 2,
...
#if args.truncate > 1 :
#    train_df = train_df[train_df['summary'].str.len() >= args.truncate]    
#    train_df = train_df.reset_index(drop=True)
...
train_input_ids, train_attention_masks, train_labels = get_encode_data(tokenizer, train_df['summary'].tolist(), train_df['code'], max_length=args.max_length)
